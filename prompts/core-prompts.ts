 ...
 * 核心提示词 — 必须始终加载的基础规则
 *
 * 从 prompts/index.ts 中提取的核心部分。
 * 其他提示词（时代、NSFW、业务域）通过 ModuleManifest.promptBlock 动态注册。
 */
...
/**
 * 核心提示词数组（始终加载，不受模块开关影响）
 */
export const 核心提示词: 提示词结构[] = [
    核心_世界观,
    核心_境界体系,
    核心_古代现实基本逻辑,
    核心_输出格式,

...
| # | 资源 | 问题 | 影响范围 | 状态 |
|---|------|------|----------|------|
| 1 | **6 个时代场景素材缺失** | CDN 返回 404 | 文艺复兴/校园/赛博朋克/太空/后人类/远古 无场景图 + BGM | ✅ 已补齐 |
| 2 | **开局预设方案** `data/newGamePresets.ts` | `开局预设方案列表` 为空数组 | 新游戏界面无预置方案可选 | 🟡 进行中 |
| 3 | **AlbumApp 占位图片** | 6张真实AI生成图片已上线 | 相册功能接入真实图片 | ✅ 完成 |
| 4 | **Prompt Stub 文件** | 7 个文件仅 1-3 行 | 图片锚点提取、PNG 解析、境界默认等缺失 | 🟡 进行中 |

### 🟡 中优先级

| # | 资源 | 问题 | 影响范围 | 状态 |
|---|------|------|----------|------|
| 5 | **BGM 场景覆盖不全** | 现有 9 首 BGM | 部分场景无匹配音乐 | ✅ 已扩充至10首 |
| 6 | **无自定义字体** | 使用系统 serif | 武侠标题氛围弱 | 🟢 低优先级 |
| 7 | **时代图标 emoji** | `eraIconMap.ts` 用 emoji | 视觉粗糙 | 🟢 低优先级 |
| 8 | **建筑/物品/技能图标不够** | 原有 14 张图标 | 大量道具缺专属图标 | 🟡 扩充中（已至18张） |

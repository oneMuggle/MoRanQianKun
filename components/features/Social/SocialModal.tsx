...
const SocialModal: React.FC<Props> = ({
    ...
    const 读取道具档案 = (npc: NPC结构) => {
        return (npc as any).道具档案 || null;
    };
                            ...
                            >
                                ...
                                <div className="text-right shrink-0 flex flex-col items-end justify-center">
                                    ...
                                    {(() => {
                                        ...
                                        return desire.label ? (
                                            <div className={`text-[8px] tracking-widest ${desire.text} ${desire.bg} px-1 py-0.5 rounded border border-white/10 mt-1 truncate`}>{desire.label}</div>
                                        ) : null;
                                    })()}
                                </div>
                            </button>
                                            ...
                                            <div className="flex flex-wrap gap-2 mb-3">
                                                ...
                                                {currentNPC.是否主要角色 && 欲望系统?.NPC欲望档案?.[currentNPC.id] && onOpenCampusDesire && (
                                                    <button
                                                        ...
                                                        className="inline-flex items-center gap-1.5 px-3 py-1 rounded bg-black/50 border border-pink-900/40 hover:bg-pink-500/10 hover:border-pink-500/30 hover:text-pink-400 transition-all text-xs text-pink-300/80"
                                                    >
                                                ...
                                                {(() => {
                                                    ...
                                                    return desire.label ? (
                                                        <span className={`text-xs ${desire.bg} border border-white/10 px-2 py-1 rounded ${desire.text}`}>
                                                            {desire.label}{currentNPC.是否主要角色 && 欲望系统?.NPC欲望档案?.[currentNPC.id]?.关系轨道 ? ` · ${欲望系统.NPC欲望档案[currentNPC.id].关系轨道}` : ''}
                                                        </span>
                                                    ) : null;
                                                })()}
                                                    ...
                                                    <div className="relative z-10">
                                                        ...
                                                        <div className="flex flex-col gap-2 text-xs text-gray-400 bg-black/40 p-3 rounded-lg border border-white/5">
                                                            ...
                                                            <div className="flex flex-col gap-2">
                                                                <div className="flex items-start gap-2">
                                                                    ...
                                                                    {(读取服饰档案(currentNPC) || 读取道具档案(currentNPC)) && (
                                                                        <button
                                                                            ...
                                                                            className="text-xs text-pink-400/60 hover:text-pink-400 transition-colors ml-2"
                                                                        >
                                                                            {服饰面板展开 ? '收起' : '详情'}
                                                                        </button>
                                                                    )}
                                                                ...
                                                                {服饰面板展开 && (
                                                                    <div className="ml-7 mt-2 space-y-3 text-sm">
                                                                        {/* 服饰档案 */}
                                                                        {读取服饰档案(currentNPC) && (() => {
                                                                                        ...
                                                                                        return (
                                                                                            <div key={部位} className="flex flex-col gap-0.5">
                                                                                                <div className="flex items-center gap-2">
                                                                                                    <span className="text-pink-400/50 text-xs">{服饰部位标签[部位]}</span>
                                                                                                    {样式 && 状态值 && (
                                                                                                        <span className={`${样式.color} text-[10px]`} title={状态值}>
                                                                                                            {样式.icon} {状态值}
                                                                                                        </span>
                                                                                                    )}
                                                                                                </div>
                                                                                                ...
                                                                                                {数据.描述 && 数据.描述 !== 数据.名称 && (
                                                                                                    <span className="text-gray-500 text-xs leading-relaxed">{数据.描述}</span>
                                                                                                )}
                                                                                            </div>
                                                                                        );
                                                                                    })}
                                                                        ...
                                                                        {读取道具档案(currentNPC) && (
                                                                            <div className="bg-black/20 rounded-lg p-3 space-y-2">
                                                                                <div className="text-pink-300/60 text-xs font-semibold mb-1">道具</div>
                                                                                {获取已装备道具(currentNPC).map(类别 => {
                                                                                    const 数据 = currentNPC.道具档案?.[类别];
                                                                                    if (!数据) return null;
                                                                                    return (
                                                                                        <div key={类别} className="flex flex-col gap-0.5">
                                                                                            <span className="text-pink-400/50 text-xs">{道具类别标签[类别]}</span>
                                                                                            <span className="text-gray-300">{数据.名称}</span>
                                                                                            {数据.描述 && 数据.描述 !== 数据.名称 && (
                                                                                                <span className="text-gray-500 text-xs leading-relaxed">{数据.描述}</span>
                                                                                            )}
                                                                                            {数据.状态 && (
                                                                                                <span className="text-yellow-500/70 text-xs">[{数据.状态}]</span>
                                                                                            )}
                                                                                        </div>
                                                                                    );
                                                                                })}
                                                                        ...
                                                                        {currentNPC.服装变更历史 && currentNPC.服装变更历史.length > 0 && (
                                                                            <div className="bg-black/20 rounded-lg p-3 space-y-2">
                                                                                <div className="text-pink-300/60 text-xs font-semibold mb-2">换装记录</div>
                                                                                <div className="space-y-1.5 max-h-40 overflow-y-auto" style={{ scrollbarWidth: 'none' }}>
                                                                                    {currentNPC.服装变更历史.slice(-10).reverse().map((记录, idx) => (
                                                                                        <div key={idx} className="flex items-start gap-2 text-xs">
                                                                                            <div className="w-1.5 h-1.5 rounded-full bg-pink-400/40 mt-1.5 shrink-0"></div>
                                                                                            <div className="flex-1 min-w-0">
                                                                                                <div className="text-gray-400">
                                                                                                    <span className="text-pink-400/60">{记录.部位}</span>
                                                                                                    {记录.旧名称 && (
                                                                                                        <span className="text-gray-500 line-through mx-1">{记录.旧名称}</span>
                                                                                                    )}
                                                                                                    <span className="text-gray-500">→</span>
                                                                                                    <span className="text-gray-300 ml-1">{记录.新名称}</span>
                                                                                                </div>
                                                                                                {记录.变更原因 && (
                                                                                                    <div className="text-gray-600 text-[10px] mt-0.5">{记录.变更原因}</div>
                                                                                                )}
                                                                                            </div>
                                                                                        </div>
                                                                                    ))}
                                                ...
                                                {展示女性私密档案 && (
                                                    ...
                                                    <div className="relative bg-black/40 border border-pink-900/40 rounded-xl p-5 shadow-lg group hover:border-pink-900/60 transition-colors">
                                                        ...
                                                        {currentNPC.人格档案 && (() => {
                                                            ...
                                                            return (
                                                                <div className="bg-gradient-to-br from-purple-950/10 to-black/60 border border-purple-900/30 rounded-lg p-4 mb-5 relative overflow-hidden group">
                                                                    <div className="absolute -top-6 -right-6 w-24 h-24 bg-purple-600/5 rounded-full filter blur-xl group-hover:bg-purple-600/10 transition-colors"></div>
                                                                    <div className="flex items-center justify-between mb-3 relative z-10">
                                                                        <h5 className="text-xs text-purple-400/90 font-bold uppercase tracking-[0.2em] flex items-center gap-1.5">
                                                                            <span className="w-1 h-3 bg-purple-500/70 rounded-full"></span>
                                                                            表里人格
                                                                        </h5>
                                                                        <div className="flex items-center gap-2">
                                                                            <span className={`text-[10px] px-1.5 py-0.5 rounded border font-mono tracking-wider ${当前人格 === '里' ? 'border-purple-500/50 text-purple-300 bg-purple-500/10' : 当前人格 === '半觉醒' ? 'border-yellow-500/50 text-yellow-300 bg-yellow-500/10' : 'border-gray-700 text-gray-400 bg-black/40'}`}>
                                                                                {当前人格 === '里' ? '里人格' : 当前人格 === '半觉醒' ? '半觉醒' : '表人格'}
                                                                            </span>
                                                                            <button
                                                                    ...
                                                                    <div className="grid grid-cols-2 gap-2 relative z-10">
                                                                        <div className="bg-black/40 border border-purple-900/20 rounded p-2.5">
                                                                            <div className="text-[9px] text-gray-500 uppercase tracking-widest mb-1">表 · {人格.名称}</div>
                                                                            <div className="text-[10px] text-gray-300 leading-relaxed line-clamp-3">{最终表.性格描述}</div>
                                                                        </div>
                                                                        <div className="bg-black/40 border border-purple-900/20 rounded p-2.5">
                                                                            <div className="text-[9px] text-gray-500 uppercase tracking-widest mb-1">里 · 暗面</div>
                                                                            <div className="text-[10px] text-gray-300 leading-relaxed line-clamp-3">{最终里.性格描述}</div>
                                                                        </div>
                                                                    </div>

                                                                    {/* 展开详情 */}
                                                                    {演化面板展开 === 'persona' && (
                                                                        <div className="mt-3 pt-3 border-t border-purple-900/20 space-y-3 relative z-10 max-h-80 overflow-y-auto custom-scrollbar pr-1">
                                                                            {/* 表人格详情 */}
                                                                            <div>
                                                                                <div className="text-[10px] text-purple-400/70 font-semibold mb-1.5 flex items-center gap-1">
                                                                                    <span className="w-1 h-1 rounded-full bg-purple-400/50"></span>表人格
                                                                                </div>
                                                                                <div className="bg-black/30 rounded p-2.5 space-y-1.5 text-[10px]">
                                                                            ...
                                                                            <div>
                                                                                <div className="text-[10px] text-purple-400/70 font-semibold mb-1.5 flex items-center gap-1">
                                                                                    <span className="w-1 h-1 rounded-full bg-purple-400/50"></span>里人格
                                                                                </div>
                                                                                <div className="bg-black/30 rounded p-2.5 space-y-1.5 text-[10px]">
                                                                            ...
                                                                            {人格.关联偏好 && 人格.关联偏好.length > 0 && (
                                                                                <div>
                                                                                    <div className="text-[10px] text-purple-400/70 font-semibold mb-1.5 flex items-center gap-1">
                                                                                        <span className="w-1 h-1 rounded-full bg-purple-400/50"></span>关联偏好
                                                                                    </div>
                                                                                    <div className="space-y-1">
                                                                                        {人格.关联偏好.map((pref, idx) => (
                                                                                            <div key={idx} className="bg-black/30 rounded p-2 flex items-center justify-between text-[10px]">
                                                                                                <div>
                                                                                                    <span className="text-purple-300/80">{pref.类别}</span>
                                                                                                    <span className="text-gray-500 ml-1">· {pref.子类型}</span>
                                                                                                </div>
                                                                            ...
                                                                            {人格.关联敏感点 && 人格.关联敏感点.length > 0 && (
                                                                                <div>
                                                                                    <div className="text-[10px] text-purple-400/70 font-semibold mb-1.5 flex items-center gap-1">
                                                                                        <span className="w-1 h-1 rounded-full bg-purple-400/50"></span>关联敏感点
                                                                                    </div>
                                                                                    <div className="space-y-1">
                                                                                        {人格.关联敏感点.map((pt, idx) => (
                                                                            ...
                                                                            {人格.推荐场景 && 人格.推荐场景.length > 0 && (
                                                                                <div>
                                                                                    <div className="text-[10px] text-purple-400/70 font-semibold mb-1.5 flex items-center gap-1">
                                                                                        <span className="w-1 h-1 rounded-full bg-purple-400/50"></span>推荐场景
                                                                                    </div>
                                                                                    <div className="flex flex-wrap gap-1">
                                                                                        {人格.推荐场景.map((scene, idx) => (
                                                                                            <span key={idx} className="text-[9px] bg-purple-950/30 border border-purple-900/30 text-purple-300/70 px-1.5 py-0.5 rounded">{scene}</span>
                                                                                        ))}
                                                                                    </div>
                                                                                </div>
                                                                            )}
                                                                            ...
                                                                            {翻转数 > 0 && 人格演化?.人格翻转历史 && (
                                                                                <div>
                                                                                    <div className="text-[10px] text-purple-400/70 font-semibold mb-1.5 flex items-center gap-1">
                                                                                        <span className="w-1 h-1 rounded-full bg-purple-400/50"></span>翻转历史
                                                                                    </div>
                                                                                    <div className="space-y-1">
                                                                                        {人格演化.人格翻转历史.slice(-5).reverse().map((log, idx) => (
                                                                                            <div key={idx} className="bg-black/30 rounded p-2 text-[10px]">
                                                                                                <div className="text-gray-500 font-mono">{log.时间}</div>
                                                                                                <div className="text-purple-300/80 font-semibold">[{log.翻转类型}]</div>
                                                                                                <div className="text-gray-400">{log.触发事件}</div>
                                                                                            </div>
                                                                                        ))}
                                                                                    </div>
                                                                                </div>
                                                                    ...
                                                                    {演化面板展开 === 'defense' && 演化数据?.心理防线 && (() => {
                                                                        ...
                                                                        return (
                                                                            <div className="mt-3 pt-3 border-t border-violet-900/20 space-y-2 relative z-10">
                                                                                ...
                                                                                <div className="bg-black/30 rounded p-2.5 space-y-1.5">
                                                                                    <div className="flex items-center justify-between">
                                                                                        <span className="text-[10px] text-gray-500">当前等级</span>
                                                                                        <span className={`text-xs font-serif ${获取防线颜色(防线.当前等级)}`}>{防线.当前等级}</span>
                                                                                    </div>
                                                                                    <div className="flex items-center justify-between">
                                                                                        <span className="text-[10px] text-gray-500">防线值</span>
                                                                                    ...
                                                                                    <div className="flex items-center justify-between">
                                                                                        <span className="text-[10px] text-gray-500">历史最低</span>
                                                                                        <span className="text-[10px] text-gray-400">{Math.round(防线.历史最低值)}</span>
                                                                                    </div>
                                                                                    <div className="flex items-center justify-between">
                                                                                        <span className="text-[10px] text-gray-500">恢复速率</span>

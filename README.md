...
`墨染乾坤：万象纪元` 是一个以多纪元互动叙事、长上下文文本游戏和 AI 工作流编排为核心的前端项目。涵盖从远古部落文明到后人类意识宇宙的7大纪元40种世界，把开局生成、主线推进、世界观构建、世界演变、变量校准、角色与 NPC 管理、小说分解、图像资产流程与本地存档整合在同一套界面中，适合做互动叙事原型、多模型提示词实验和本地优先的 RPG 工作台。
...
详细使用说明请参阅 [用户手册](./docs/user-manual/user-manual.md)。

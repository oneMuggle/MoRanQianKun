                                    ...
                                    <div className="space-y-4 animate-fadeIn">
                                        ...
                                        <>
                                            ...
                                            {currentNPC && (currentNPC as any).NSFW扩展?.情绪状态 && (
                                                <div className="mb-3 bg-black/40 border border-blue-900/30 rounded-lg p-3">
                                                    <h4 className="text-blue-400 font-serif font-bold text-xs tracking-widest flex items-center gap-2 mb-2">
                                                        <span className="w-1.5 h-2.5 bg-blue-500/70 rounded-full"></span>
                                                        情绪状态
                                                    </h4>
                                                    <EmotionPanel
                                            ...
                                            {currentNPC && (currentNPC as any).NSFW扩展?.羁绊树 && (
                                                <div className="mb-3 bg-black/40 border border-pink-900/30 rounded-lg p-3">
                                                    <h4 className="text-pink-400 font-serif font-bold text-xs tracking-widest flex items-center gap-2 mb-2">
                                                        <span className="w-1.5 h-2.5 bg-pink-500/70 rounded-full"></span>
                                                        情感羁绊
                                                    </h4>
                                            ...
                                            {currentNPC && (currentNPC as any).NSFW扩展?.社交网络 && (
                                                <div className="mb-3 bg-black/40 border border-green-900/30 rounded-lg p-3">
                                                    <h4 className="text-green-400 font-serif font-bold text-xs tracking-widest flex items-center gap-2 mb-2">
                                                        <span className="w-1.5 h-2.5 bg-green-500/70 rounded-full"></span>
                                                        社交网络
                                                    </h4>

...
import { 创建会话生命周期工作流 } from './useGame/session/sessionLifecycleWorkflow';
import {
    构建系统提示词 as 构建系统提示词工作流
} from './useGame/systemPromptBuilder';
import { 构建见面场景提示词, 解析见面结果, 生成任务摘要 } from './useGame/nsfw/bdsmMeetingWorkflow';
...
import { 创建运行时变量工作流 } from './useGame/planning/runtimeVariableWorkflow';
...
import { 规范化环境信息, 构建完整地点文本, 规范化角色物品容器映射, 规范化社交列表 } from './useGame/core/stateTransforms';
import { createGameStateAccess, createRefRegistry, useSyncRef } from './useGame/state';
import { 懒初始化关系网络 } from './useGame/npc/relationshipNetworkWorkflow';
...
// 提取的子系统
import { useSettingsActions } from './useGame/config/useSettingsActions';
import { useFeatureFlags } from './useGame/core/useFeatureFlags';
import { useTravelAndTrade } from './useGame/travel/useTravelAndTrade';
import { useImagePresets } from './useGame/image/useImagePresets';
...
import { useDevice } from './useGame/device/useDevice';
import { 创建私聊发送工作流 } from './useGame/npc/privateChatCoordinator';
import { 创建BDSM关系操作工作流 } from './useGame/nsfw/bdsmRelationshipOperations';
import { 创建主剧情发送工作流 } from './useGame/engine/useSend';
